...
export default function Home() {
  ...
  const [pessoasOnline, setPessoasOnline] = useState(347);
...
<div className="text-center mb-12">
  ...
  <div className="flex flex-wrap items-center justify-center gap-8 mb-12">
    <div className="text-center">
      <p className="text-4xl font-bold text-yellow-400">2.847+</p>
      <p className="text-purple-200 text-sm">Vidas Transformadas</p>
    </div>
    <div className="text-center">
      <p className="text-4xl font-bold text-yellow-400">4.9/5</p>
      <p className="text-purple-200 text-sm">⭐⭐⭐⭐⭐</p>
    </div>
    <div className="text-center">
      <p className="text-4xl font-bold text-yellow-400">2 min</p>
      <p className="text-purple-200 text-sm">Resultado Instantâneo</p>
    </div>
  </div>
</div>
        </div>
...
<div className="max-w-2xl mx-auto mb-6">
  <div className="bg-red-900/30 border border-red-500/50 rounded-lg p-4 flex items-center justify-center gap-3 animate-pulse">
    <div className="w-3 h-3 bg-red-500 rounded-full animate-ping"></div>
    <p className="text-red-200">
🔥 <strong>{pessoasOnline} pessoas</strong> estão visualizando esta página agora    </p>
  </div>
</div>
...
<div className="mt-16 grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
  <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-purple-500/30 text-center hover:scale-105 transition-transform">
    <div className="text-5xl mb-4">🔮</div>
    <h3 className="font-bold text-xl mb-3">Análise Completa</h3>
    <p className="text-purple-200 text-sm">Numerologia + Astrologia + IA personalizada</p>
  </div>
  <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-purple-500/30 text-center hover:scale-105 transition-transform">
    <div className="text-5xl mb-4">⚡</div>
    <h3 className="font-bold text-xl mb-3">Resultado Instantâneo</h3>
    <p className="text-purple-200 text-sm">Receba sua análise em menos de 2 minutos</p>
  </div>
  <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-purple-500/30 text-center hover:scale-105 transition-transform">
    <div className="text-5xl mb-4">💎</div>
    <h3 className="font-bold text-xl mb-3">100% Personalizado</h3>
    <p className="text-purple-200 text-sm">Análise única gerada para você</p>
  </div>
</div>
          <div className="text-center">
