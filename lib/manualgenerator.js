...
Em ${signo}${elemento ? ` (${elemento})` : ''}, isso ganha um contorno específico: ${s?.motor || 'sua forma de agir e sentir'} entra em contato direto com ${palavras || 'o tema desta carta'}. O ponto de atenção de ${signo} — ${s?.risco || 'o excesso que te desequilibra'} — é justamente o que essa carta está pedindo para você olhar de frente.
