 ...
 * } | null}
 */
export function calcularHumanDesign(dataNascimentoISO, horaNascimento = null) {
  const corpos = calcularCorposCelestesParaHumanDesign(dataNascimentoISO, horaNascimento);
  ...
  return {
    ...
    personalidade,
    design,
    avisoPrecisao: 'Cálculo próprio (sem Swiss Ephemeris), precisão de ~1-2°. Perto de uma fronteira de portão (a cada 5,625°) o resultado pode ocasionalmente variar. Recomendado validar contra um app de referência antes de uso comercial em larga escala.',
  };
}
